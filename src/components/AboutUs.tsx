          ...
          <div className="flex justify-center">
            {certificates.map((cert, index) => (
              <motion.div
                ...
                className="group relative bg-[#f8f8f6] border border-neutral-200/90 hover:border-[#f5901e] rounded-2xl overflow-hidden shadow-xs hover:shadow-xl transition-colors cursor-pointer flex flex-col max-w-md w-full"
              >
                {/* Image Wrap */}
